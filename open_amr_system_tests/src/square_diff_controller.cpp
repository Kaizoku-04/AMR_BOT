/**
 * @file square_diff_controller.cpp
 * @brief Controls a diff wheeled robot to move in a square pattern
 *
 * This program creates a ROS 2 node that publishes velocity commands to make a
 * diff wheeled robot move in a square pattern. It takes advantage of the
 * omnidirectional capabilities of diff wheels to move in straight lines
