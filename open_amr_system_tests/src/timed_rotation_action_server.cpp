 ...
 *
 * This program implements a ROS 2 action server that executes timed rotation actions for the Open AMR robot.
 ...
 *
 * Action Server:
 *   timed_rotation (open_amr_msgs/action/TimedRotation):
...
#include "open_amr_msgs/action/timed_rotation.hpp"
#include "geometry_msgs/msg/twist_stamped.hpp"

using namespace std::chrono_literals;
using TimedRotation = open_amr_msgs::action::TimedRotation;
