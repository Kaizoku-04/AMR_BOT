 ...
 *
 * Services:
 *   /set_cleaning_state (open_amr_msgs/srv/SetCleaningState):
...
#include "open_amr_msgs/srv/set_cleaning_state.hpp"
...
public:
  ...
  {
    service_ = this->create_service<open_amr_msgs::srv::SetCleaningState>(
      "/set_cleaning_state",
...
private:
  ...
  void set_cleaning_state_callback(
    const std::shared_ptr<open_amr_msgs::srv::SetCleaningState::Request> request,
    std::shared_ptr<open_amr_msgs::srv::SetCleaningState::Response> response)
  {
  ...
  rclcpp::Service<open_amr_msgs::srv::SetCleaningState>::SharedPtr service_;
};
