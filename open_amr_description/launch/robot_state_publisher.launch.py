#!/usr/bin/env python3
"""
Launch RViz visualization for the OpenAMR robot.
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='open_amr',
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = 'open_amr_description'
    urdf_filename = 'open_amr.urdf.xacro'
    rviz_config_filename = 'open_amr_description.rviz'
