#!/usr/bin/env python3
"""
Launch Gazebo simulation with the OpenAMR robot.
...
def generate_launch_description():
    ...
    package_name_description = 'open_amr_description'
    package_name_bringup = 'open_amr_bringup'

    default_robot_name = 'open_amr'
    gazebo_models_path = 'models'
    default_world_file = 'empty.world'
    gazebo_worlds_path = 'worlds'
    ros_gz_bridge_config_file_path = 'config/ros_gz_bridge.yaml'
    rviz_config_filename = 'open_amr_gazebo_sim.rviz'
