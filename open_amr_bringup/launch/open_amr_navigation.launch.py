#!/usr/bin/env python3
"""
Launch Nav2 for the OpenAMR robot in Gazebo.
...
def generate_launch_description():
    ...
    package_name_docking = 'open_amr_docking'
    package_name_gazebo = 'open_amr_gazebo'
    package_name_localization = 'open_amr_localization'
    package_name_navigation = 'open_amr_navigation'

    # Launch and config file paths
    apriltag_launch_file_path = 'launch/apriltag_dock_pose_publisher.launch.py'
    gazebo_launch_file_path = 'launch/open_amr.gazebo.launch.py'
    ...
    nav2_params_path = 'config/open_amr_nav2_default_params.yaml'
    ...
    start_assisted_teleop_cmd = Node(
        package='open_amr_navigation',
        executable='assisted_teleoperation.py',
        output='screen',
        parameters=[{'use_sim_time': use_sim_time}]
    )

    # Start the node that relays /cmd_vel to /diff_drive_controller/cmd_vel
